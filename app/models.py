...
class ServiceType(models.Model):
    name = models.CharField(max_length=100, verbose_name='Вид услуги')
...
class Service(models.Model):
    ...
    type = models.ForeignKey(ServiceType, verbose_name='Вид услуги', on_delete=models.CASCADE, related_name='services')
